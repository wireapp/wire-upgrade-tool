...
```sh
pip install https://github.com/wireapp/wire-upgrade-tool/releases/download/v0.1.4/wire_upgrade-0.1.4-py3-none-any.whl
```
...
```sh
pip install --upgrade https://github.com/wireapp/wire-upgrade-tool/releases/download/v0.1.4/wire_upgrade-0.1.4-py3-none-any.whl
```
