...
def parse_args(argv=None):
    ...
    parser.add_argument('--kubectl-cmd', default='kubectl', help='Kubectl command wrapper (default: kubectl)')
    ...
    parser.add_argument('--offline-env', default='', help='Path to offline-env.sh to source before shell commands')
